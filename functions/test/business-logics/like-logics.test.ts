...
describe("onLikeLogic", () => {
  ...
  it("should return return error logic result if post docpath is invalid",
    async () => {
  ...
  it("should return error logic result if post does not exist",
    async () => {
  ...
  it("should return finished logic result to increment likes count document",
    async () => {
      const result = await onLikeLogic.logicFn(action);
  ...
  it("should return finished logic result to create like document",
    async () => {
      const result = await onLikeLogic.logicFn(action);
